...
export function Footer() {
  return (
    <footer className="bg-yasna-darkBg py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-white/20 pt-8 mb-8">
          <nav className="flex flex-wrap justify-center gap-8 font-sans text-white/70">
            <a href="#about" className="hover:text-yasna-accent transition-colors">О проекте</a>
            <a href="#departments" className="hover:text-yasna-accent transition-colors">Направления</a>
            <a href="#how-to-join" className="hover:text-yasna-accent transition-colors">Как участвовать</a>
            <a href="#contacts" className="hover:text-yasna-accent transition-colors">Контакты</a>
          </nav>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm font-sans text-white/60 space-y-2 md:space-y-0">
          ...
          <a href="#privacy" className="hover:text-yasna-accent transition-colors">
