...
export function Footer() {
  return (
    <footer id="contacts" className="bg-yasna-darkBg py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start mb-12">
          ...
          <div className="flex flex-col space-y-3 mt-6 md:mt-0">
            <div className="flex items-center space-x-2 font-sans text-white/80 cursor-default">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm font-sans text-white/60 space-y-2 md:space-y-0">
          ...
          <Link id="privacy" to="/#privacy" className="hover:text-yasna-accent transition-colors">
